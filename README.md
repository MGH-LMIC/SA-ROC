...
## Quick Start (Minimal Example)python
...
## Core Diagnostics (Recommended Plots)python
...
Each routine returns (policy_dict | None, reason), where policy_dict = {"tau_minus": ..., "tau_plus": ...}.python
